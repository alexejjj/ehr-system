...
@Generated(
    ...
    date = "2022-05-21T16:47:30.327233+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.20.0-SNAPSHOT"
)
@OptionFor("INTERVAL_EVENT")
public class SkinDiseaseRiskAnyEventIntervalEvent implements IntervalEventEntity, SkinDiseaseRiskAnyEventChoice {
  /**
  ...
  /**
   * Path: Onco-dermatology encounter.v0/Health and lifestyle/Skin disease risk/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: Onco-dermatology encounter.v0/Health and lifestyle/Skin disease risk/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: Onco-dermatology encounter.v0/Health and lifestyle/Skin disease risk/Any event/sample_count
   */
  @Path("/sample_count")
