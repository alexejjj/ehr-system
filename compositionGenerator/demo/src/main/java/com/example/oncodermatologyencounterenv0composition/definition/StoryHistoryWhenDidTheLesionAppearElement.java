...
@Generated(
    ...
    date = "2022-05-21T16:47:30.351100+03:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.20.0-SNAPSHOT"
)
public class StoryHistoryWhenDidTheLesionAppearElement implements LocatableEntity {
  /**
  ...
  /**
   * Path: Onco-dermatology encounter.v0/Anamnesis/Story/History/Any event/Tree/When did the lesion appear?/null_flavour
   */
