...
public class PhysicalExaminationFindingsObservationContainment extends Containment {
  ...
  public ListSelectAqlField<Cluster> DEVICE_DETAILS = new ListAqlFieldImp<Cluster>(PhysicalExaminationFindingsObservation.class, "/protocol[at0007]/items[at0010]", "deviceDetails", Cluster.class, this);
