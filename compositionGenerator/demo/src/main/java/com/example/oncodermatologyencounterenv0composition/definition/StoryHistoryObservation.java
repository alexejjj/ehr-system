...
@Generated(
    ...
    date = "2022-05-21T16:47:30.348232+03:00",
...
public class StoryHistoryObservation implements EntryEntity {
  /**
   * Path: Onco-dermatology encounter.v0/Anamnesis/Story/History/origin
   */
  @Path("/data[at0001]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: Onco-dermatology encounter.v0/Anamnesis/Story/History/Extension
  ...
  /**
   * Path: Onco-dermatology encounter.v0/Anamnesis/Story/History/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Onco-dermatology encounter.v0/Anamnesis/Story/History/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Onco-dermatology encounter.v0/Anamnesis/Story/History/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: Onco-dermatology encounter.v0/Anamnesis/Story/History/Any event
